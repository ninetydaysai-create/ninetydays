    ...
    <div className="space-y-7">
      ...
      {readinessScore !== null ? (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <div className="text-xs text-slate-500 mt-1">Target: {TARGET_READINESS}% to apply</div>
          </div>
          ...
          {rejectionRisk && (
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="text-xs text-slate-500 mt-1">{rejectionRisk.advice}</div>
            </div>
          )}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="text-xs text-slate-500 mt-1 font-semibold uppercase tracking-wide">{s.sub}</div>
            </div>
          ))}
        </div>
      )}
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="flex items-start gap-4 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-slate-500 text-sm mt-1 leading-relaxed">{biggestBlocker.description}</p>
                <p className="text-xs text-slate-400 mt-2">~{biggestBlocker.estimatedHours}h to close · Addressing this alone could raise your readiness by 5–10%</p>
              </div>
            </div>
      ...
      {roadmap && allTasks.length > 0 && (
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
          ...
          <p className="text-xs text-slate-400 mt-2">{completedTasks} of {allTasks.length} tasks done</p>
